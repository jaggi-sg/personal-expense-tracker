...
export const CHART_THEMES = {
  ...
  forest: {
    ...
    secondary:'#15803d',
    accent:'#84cc16',
    recurring:{border:'#4ade80',bg:'rgba(74,222,128,.08)',bar:'rgba(22,101,52,.75)'},
    nonRecurring:{border:'#bef264',bg:'rgba(190,242,100,.08)',bar:'rgba(21,128,61,.75)'},
    pie:[
      'rgba(22,101,52,.85)',
      'rgba(21,128,61,.85)',
      'rgba(132,204,22,.85)',
  ...
  royal: {
    ...
    recurring: {
      ...
      bar: 'rgba(29,78,216,0.75)'
    },
    nonRecurring: {
      border: '#fde047',
      bg: 'rgba(253,224,71,0.08)',
      bar: 'rgba(202,138,4,0.75)'
    },
    pie: [
      'rgba(29,78,216,0.85)',
      'rgba(202,138,4,0.85)',
  ...
  neon: {
    ...
    gradient: 'from-blue-600 via-fuchsia-500 to-lime-400',
    ringColor: '#2563eb',
    bgMid: '#172554',
    bgMidLight: '#bfdbfe',
  },
  arctic: {
    ...
    recurring: {
      ...
      bar: 'rgba(14,165,233,0.75)'
    },
    nonRecurring: {
      border: '#bae6fd',
      bg: 'rgba(186,230,253,0.08)',
  ...
  galaxy: {
    ...
    recurring: {
      ...
      bar: 'rgba(49,46,129,0.75)'
    },
    nonRecurring: {
      border: '#22d3ee',
      bg: 'rgba(34,211,238,0.08)',
      bar: 'rgba(67,56,202,0.75)'
    },
    pie: [
      'rgba(49,46,129,0.85)',
      'rgba(67,56,202,0.85)',
    ...
    gradient: 'from-indigo-900 via-purple-700 to-cyan-500',
    ringColor: '#312e81',
    bgMid: '#1e1b4b',
    bgMidLight: '#ddd6fe',
  },
  ruby: {
    ...
    recurring: {
      ...
      bar: 'rgba(153,27,27,0.75)'
    },
    nonRecurring: {
      border: '#fca5a5',
      bg: 'rgba(252,165,165,0.08)',
      bar: 'rgba(220,38,38,0.75)'
    },
    pie: [
      'rgba(153,27,27,0.85)',
      'rgba(220,38,38,0.85)',
